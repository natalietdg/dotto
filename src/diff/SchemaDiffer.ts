...
import { GraphNode, PropertyInfo } from '../core/types';
...
export interface SchemaChange {
  type: 'field_added' | 'field_removed' | 'field_type_changed' | 'field_required_changed' | 'intent_changed' | 'enum_value_changed';
  path: string;
  oldValue?: any;
  newValue?: any;
  breaking: boolean;
